        ...
        utility = {
            ...
            scrollTo: function(element, to, duration) {
                ...
                var animateScroll = function(elapsedTime) {
                    ...
                    var position = utility.easeInOut(elapsedTime, start, change, duration);
            ...
            storePageIn: function(object, url, doc, id) {
                var $html = ($html instanceof jQuery) ? $html : utility.htmlDoc(doc),
                    wpadminbar = $(doc).filter('#wpadminbar'),
                    parsedMeta = $(doc).filter('meta');
                ...
                object[url] = { // Content is indexed by the url
                    ...
                    meta: {
                        bodyId: $html.find('body').attr('id'),
                        bodyClasses: $html.find('body').attr('class'),
                        bodyCSS: $html.find('body').attr('style'),
                        wpadminbar: wpadminbar,
                        meta_tags: $(parsedMeta)
                    }
                };
                return object;
            },
        ...
        Smoothstate = function(element, options) {
            var
                ...
                repositionWindow = function() {
                    ...
                    if (targetHash) {
                        ...
                        if ($targetHashEl.length) {
                            ...
                            utility.scrollTo(document.body, newPosition, 250);
                        }
                        targetHash = null;
                    }
                },
                ...
                updateContent = function(url) {
                    ...
                    if($wpadminbar.length > 0) $wpadminbar.html(cache[url].meta.wpadminbar.html());
                    ...
                    if ($content) {
                        ...
                        $('meta').remove();
                        $('html head').prepend(cache[url].meta.meta_tags);
                        $container.data('smoothState').href = url;

                        // Call the onEnd callback and set trigger
                        options.onReady.render(url, $container, $content);
                    ...
                    } else if (!$content && options.debug && consl) {
                        // Throw warning to help debugging
                ...
                load = function(request, push, cacheResponse) {
                            ...
                            loaded: function() {
                                ...
                                if (push) {
                                    window.history.pushState({
                                        id: elementId
                                    }, cache[settings.url].title, settings.url);
                                }
                    ...
                    window.setTimeout(function() {
                        utility.scrollTo(document.body, 0, 0);
